...
class EnhancedVAE(nn.Module):
    ...
    def forward(self, virus_data, host_data, noise=None):
        ...
        return logits, decoded_outputs#,host_features,virus_features_norm,extracted_decoded_output,combined_z
    ...
    def save_pretrained(self, file_path, step):
        ...
        torch.save(self.module.state_dict(), model_weights_path)
